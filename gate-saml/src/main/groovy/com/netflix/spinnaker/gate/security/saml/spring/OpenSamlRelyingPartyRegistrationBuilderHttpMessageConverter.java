...
/**
 * An {@link HttpMessageConverter} that takes an {@code IDPSSODescriptor} in an HTTP response and
 * converts it into a {@link RelyingPartyRegistration.Builder}.
 *
 * <p>The primary use case for this is constructing a {@link RelyingPartyRegistration} for inclusion
 * in a {@link RelyingPartyRegistrationRepository}. To do so, you can include an instance of this
 * converter in a {@link org.springframework.web.client.RestOperations} like so:
 *
 * <pre>
 ...
 * </pre>
 *
 * Note that this will only configure the asserting party (IDP) half of the {@link
 * RelyingPartyRegistration}, meaning where and how to send AuthnRequests, how to verify Assertions,
 * etc.
 *
 * <p>To further configure the {@link RelyingPartyRegistration} with relying party (SP) information,
...
public class OpenSamlRelyingPartyRegistrationBuilderHttpMessageConverter
  ...
  @Override
  public RelyingPartyRegistration.Builder read(
      Class<? extends RelyingPartyRegistration.Builder> clazz, HttpInputMessage inputMessage)
    ...
    RelyingPartyRegistration.Builder builder =
        RelyingPartyRegistration.withRegistrationId(descriptor.getEntityID())
            .assertingPartyDetails(
                (party) ->
                    party
                        .entityId(descriptor.getEntityID())
                        .wantAuthnRequestsSigned(
                            Boolean.TRUE.equals(idpssoDescriptor.getWantAuthnRequestsSigned()))
  ...
  public void write(
    ...
    throw new HttpMessageNotWritableException(
        "This converter cannot write a RelyingPartyRegistration.Builder");
  }
}
