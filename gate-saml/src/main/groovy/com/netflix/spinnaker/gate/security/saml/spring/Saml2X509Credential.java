...
/**
 * An object for holding a public certificate, any associated private key, and its intended <a href=
...
public final class Saml2X509Credential {
   ...
   * @param types the credential's intended usages, must be one of {@link
   *     Saml2X509CredentialType#VERIFICATION} or {@link Saml2X509CredentialType#ENCRYPTION} or
   *     both.
   */
   ...
   * @param types the credential's intended usages, must be one of {@link
   *     Saml2X509CredentialType#SIGNING} or {@link Saml2X509CredentialType#DECRYPTION} or both.
   */
  public Saml2X509Credential(
      PrivateKey privateKey, X509Certificate certificate, Saml2X509CredentialType... types) {
   ...
   */
  public Saml2X509Credential(
      PrivateKey privateKey, X509Certificate certificate, Set<Saml2X509CredentialType> types) {
  ...
  public static Saml2X509Credential encryption(X509Certificate certificate) {
    return new Saml2X509Credential(
        certificate, Saml2X509Credential.Saml2X509CredentialType.ENCRYPTION);
  }
  ...
  private void validateUsages(
      Saml2X509CredentialType[] usages, Saml2X509CredentialType... validUsages) {
