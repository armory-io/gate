...
/**
 * Represents a configured relying party (aka Service Provider) and asserting party (aka Identity
 * Provider) pair.
 *
 * <p>Each RP/AP pair is uniquely identified using a {@code registrationId}, an arbitrary string.
 *
 * <p>A fully configured registration may look like:
 *
 * <pre>
...
public final class RelyingPartyRegistration {
  ...
  private final List<org.springframework.security.saml2.credentials.Saml2X509Credential>
      credentials;
  ...
  private RelyingPartyRegistration(
    ...
    Assert.hasText(
        assertionConsumerServiceLocation, "assertionConsumerServiceLocation cannot be empty");
    Assert.notNull(
        assertionConsumerServiceBinding, "assertionConsumerServiceBinding cannot be null");
    ...
    for (Saml2X509Credential c : signingX509Credentials) {
      ...
      Assert.isTrue(
          c.isSigningCredential(), "All signingX509Credentials must have a usage of SIGNING set");
    }
    ...
    this.decryptionX509Credentials =
        Collections.unmodifiableList(new LinkedList<>(decryptionX509Credentials));
    this.signingX509Credentials =
        Collections.unmodifiableList(new LinkedList<>(signingX509Credentials));
  }
   ...
   *
   * <p>Equivalent to the value found in the relying party's &lt;EntityDescriptor
   * EntityID="..."/&gt;
   *
   * <p>This value may contain a number of placeholders, which need to be resolved before use. They
   * are {@code baseUrl}, {@code registrationId}, {@code baseScheme}, {@code baseHost}, and {@code
   * basePort}.
   *
   ...
   * &lt;AssertionConsumerService Binding="..."/&gt; in the relying party's &lt;SPSSODescriptor&gt;.
   *
  ...
  /**
   * Get the {@link Collection} of decryption {@link Saml2X509Credential}s associated with this
   * relying party
   *
   * @return the {@link Collection} of decryption {@link Saml2X509Credential}s associated with this
   *     relying party
   * @since 5.4
   */
  ...
  /**
   * Get the {@link Collection} of signing {@link Saml2X509Credential}s associated with this relying
   * party
   *
   * @return the {@link Collection} of signing {@link Saml2X509Credential}s associated with this
   *     relying party
   * @since 5.4
   */
   ...
   * @deprecated use {@link AssertingPartyDetails#getEntityId} from {@link
  ...
  /**
   * returns the URL template for which ACS URL authentication requests should contain Possible
   * variables are {@code baseUrl}, {@code registrationId}, {@code baseScheme}, {@code baseHost},
   * and {@code basePort}.
   *
  ...
  /**
   * Contains the URL for which to send the SAML 2 Authentication Request to initiate a single sign
   * on flow.
   *
   * @return a IDP URL that accepts REDIRECT or POST binding for authentication requests
   * @deprecated use {@link AssertingPartyDetails#getSingleSignOnServiceLocation} from {@link
   *     #getAssertingPartyDetails}
   */
  @Deprecated
  ...
  /**
   * The local relying party, or Service Provider, can generate it's entity ID based on possible
   * variables of {@code baseUrl}, {@code registrationId}, {@code baseScheme}, {@code baseHost}, and
   * {@code basePort}, for example {@code
  ...
  /**
   * Returns a list of configured credentials to be used in message exchanges between relying party,
   * SP, and asserting party, IDP.
   *
   * @return a list of credentials
   * @deprecated Instead of retrieving all credentials, use the appropriate method for obtaining the
   *     correct type
   */
  @Deprecated
  ...
  /**
   * @return a filtered list containing only credentials of type {@link
   ...
   */
  @Deprecated
  public List<org.springframework.security.saml2.credentials.Saml2X509Credential>
  ...
  private List<org.springframework.security.saml2.credentials.Saml2X509Credential>
      filterCredentials(
          Function<org.springframework.security.saml2.credentials.Saml2X509Credential, Boolean>
              filter) {
    List<org.springframework.security.saml2.credentials.Saml2X509Credential> result =
        new LinkedList<>();
  ...
  private static org.springframework.security.saml2.credentials.Saml2X509Credential toDeprecated(
    ...
    PrivateKey privateKey = credential.getPrivateKey();
    X509Certificate certificate = credential.getCertificate();
    Set<org.springframework.security.saml2.credentials.Saml2X509Credential.Saml2X509CredentialType>
        credentialTypes = new HashSet<>();
    if (credential.isSigningCredential()) {
      credentialTypes.add(
    ...
    return new org.springframework.security.saml2.credentials.Saml2X509Credential(
        privateKey,
        certificate,
        credentialTypes.toArray(
            new org.springframework.security.saml2.credentials.Saml2X509Credential
                    .Saml2X509CredentialType[0]));
  }
  ...
  public static final class AssertingPartyDetails {
    ...
    private AssertingPartyDetails(
      ...
      for (Saml2X509Credential credential : verificationX509Credentials) {
        ...
        Assert.isTrue(
            credential.isVerificationCredential(),
      ...
      for (Saml2X509Credential credential : encryptionX509Credentials) {
        ...
        Assert.isTrue(
            credential.isEncryptionCredential(),
     ...
     * "https://wiki.shibboleth.net/confluence/display/CONCEPT/EntityNaming">EntityID</a>.
     *
     * <p>Equivalent to the value found in the asserting party's &lt;EntityDescriptor
     * EntityID="..."/&gt;
     *
     * <p>This value may contain a number of placeholders, which need to be resolved before use.
     * They are {@code baseUrl}, {@code registrationId}, {@code baseScheme}, {@code baseHost}, and
     * {@code basePort}.
     *
     ...
     * Location.
     *
     * <p>Equivalent to the value found in &lt;SingleSignOnService Location="..."/&gt; in the
     ...
     * Binding.
     *
     * <p>Equivalent to the value found in &lt;SingleSignOnService Binding="..."/&gt; in the
     * asserting party's &lt;IDPSSODescriptor&gt;.
     *
     * @return the SingleSignOnService Location
     */
    ...
    public static final class Builder {
       ...
       *
       * @param credentialsConsumer a {@link Consumer} of the {@link List} of {@link
       *     Saml2X509Credential}s
       * @return the {@link RelyingPartyRegistration.Builder} for further configuration
       * @since 5.4
       */
      public Builder verificationX509Credentials(
          Consumer<Collection<Saml2X509Credential>> credentialsConsumer) {
       ...
       * @since 5.4
       */
      public Builder encryptionX509Credentials(
          Consumer<Collection<Saml2X509Credential>> credentialsConsumer) {
      ...
      /**
       * Creates an immutable ProviderDetails object representing the configuration for an Identity
       * Provider, IDP
       *
  ...
  public static final class ProviderDetails {
    ...
    /**
     * Contains the URL for which to send the SAML 2 Authentication Request to initiate a single
     * sign on flow.
     *
     * @return a IDP URL that accepts REDIRECT or POST binding for authentication requests
     */
    ...
    public static final class Builder {
       ...
       *
       * @param binding either {@link Saml2MessageBinding#POST} or {@link
  ...
  public static final class Builder {
    ...
    private Collection<org.springframework.security.saml2.credentials.Saml2X509Credential>
     ...
     *
     * <p>This value may contain a number of placeholders. They are {@code baseUrl}, {@code
     * registrationId}, {@code baseScheme}, {@code baseHost}, and {@code basePort}.
     *
     * @return the {@link Builder} for further configuration
     * @since 5.4
     */
    ...
    /**
     * Apply this {@link Consumer} to the {@link Collection} of {@link Saml2X509Credential}s for the
     * purposes of modifying the {@link Collection}
     *
     * @param credentialsConsumer - the {@link Consumer} for modifying the {@link Collection}
     * @return the {@link Builder} for further configuration
     * @since 5.4
     */
    public Builder signingX509Credentials(
        Consumer<Collection<Saml2X509Credential>> credentialsConsumer) {
     ...
     * @since 5.4
     */
    public Builder decryptionX509Credentials(
        Consumer<Collection<Saml2X509Credential>> credentialsConsumer) {
     ...
     * Location.
     *
     * <p>Equivalent to the value found in &lt;AssertionConsumerService Location="..."/&gt; in the
     ...
     * Binding.
     *
     * <p>Equivalent to the value found in &lt;AssertionConsumerService Binding="..."/&gt; in the
     * relying party's &lt;SPSSODescriptor&gt;
     *
     ...
     * @since 5.4
     */
    public Builder assertionConsumerServiceBinding(
        Saml2MessageBinding assertionConsumerServiceBinding) {
      this.assertionConsumerServiceBinding = assertionConsumerServiceBinding;
      return this;
    }
     ...
     * @since 5.4
     */
    public Builder assertingPartyDetails(
        Consumer<AssertingPartyDetails.Builder> assertingPartyDetails) {
      assertingPartyDetails.accept(this.providerDetails.assertingPartyDetailsBuilder);
      return this;
    }

    /**
     * Modifies the collection of {@link Saml2X509Credential} objects used in communication between
     * IDP and SP For example: <code>
     *     Saml2X509Credential credential = ...;
     ...
     *     for relying party keys or {@link
     *     AssertingPartyDetails.Builder#verificationX509Credentials} or {@link
     *     AssertingPartyDetails.Builder#encryptionX509Credentials} for asserting party keys
     */
    @Deprecated
    public Builder credentials(
        Consumer<Collection<org.springframework.security.saml2.credentials.Saml2X509Credential>>
            credentials) {
     ...
     * Consumer Service</a> URL template. It can contain variables {@code baseUrl}, {@code
     * registrationId}, {@code baseScheme}, {@code baseHost}, and {@code basePort}.
     *
     ...
     * @return this object
     * @deprecated use {@code #assertingPartyDetails(Consumer<AssertingPartyDetails.Builder >)}
     */
    @Deprecated
    ...
    /**
     * Sets the local relying party, or Service Provider, entity Id template. can generate it's
     * entity ID based on possible variables of {@code baseUrl}, {@code registrationId}, {@code
     * baseScheme}, {@code baseHost}, and {@code basePort}, for example {@code
     * {baseUrl}/saml2/service-provider-metadata/{registrationId}}
     *
     * @return a string containing the entity ID or entity ID template
    ...
    public RelyingPartyRegistration build() {
      for (org.springframework.security.saml2.credentials.Saml2X509Credential credential :
          this.credentials) {
        ...
        if (credential.isSignatureVerficationCredential()) {
          this.providerDetails.assertingPartyDetailsBuilder.verificationX509Credentials(
              (c) -> c.add(mapped));
        }
        if (credential.isEncryptionCredential()) {
          this.providerDetails.assertingPartyDetailsBuilder.encryptionX509Credentials(
              (c) -> c.add(mapped));
        }
      }
      ...
      for (Saml2X509Credential credential :
          this.providerDetails.assertingPartyDetailsBuilder.verificationX509Credentials) {
        this.credentials.add(toDeprecated(credential));
      }
      for (Saml2X509Credential credential :
